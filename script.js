...
scene.fog = new THREE.FogExp2(0xc0ffd5, .4);
...
var floorM = new THREE.MeshLambertMaterial({ color: 0x588a92 });
...
for (var i = 0; i < 1000; ++i) {
  ...
  var material = new THREE.MeshLambertMaterial({ color: 0x6dd4ff });
...
$(window).scroll(function () {
  camera.position.y = 3 - ($(this).scrollTop() / 1000);
});